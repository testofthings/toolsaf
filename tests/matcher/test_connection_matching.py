...
def test_connection_basics():
    ...
    flow = IPFlow.TCP("a:0:0:0:0:1", "12.0.0.1", 20123) >> ("a:0:0:0:0:2", "12.0.0.2", 1234)
    ...
    # reverse direction
    flow = IPFlow.TCP("a:0:0:0:0:1", "12.0.0.1", 20124) << ("a:0:0:0:0:2", "12.0.0.2", 1234)
    fm = FlowMatcher(engine, flow)
    conn = fm.get_connection()
    assert conn == dev0_dev1_1234
    assert fm.get_host_addresses() == (
    ...
    flow = IPFlow.TCP("a:0:0:0:0:1", "12.0.0.1", 20123) >> ("a:0:0:0:1:1", "12.0.1.1", 1234)
    fm = FlowMatcher(engine, flow)
    conn = fm.get_connection()
    ...
    flow = IPFlow.TCP("a:0:0:0:0:1", "12.0.0.1", 8888) >> ("a:0:0:0:1:1", "12.0.0.2", 1088)
    fm = FlowMatcher(engine, flow)
    conn = fm.get_connection()
    ...
    flow = IPFlow.TCP("a:0:0:0:0:1", "12.0.0.1", 8888) >> ("a:0:0:0:1:1", "12.0.1.1", 2234)
    fm = FlowMatcher(engine, flow)
    conn = fm.get_connection()
    ...
    flow = IPFlow.TCP("a:0:0:0:2:1", "12.0.2.1", 8888) >> ("a:0:0:0:1:1", "12.0.1.1", 2010)
    fm = FlowMatcher(engine, flow)
    conn = fm.get_connection()
...
def test_connection_no_match():
    ...
    flow = IPFlow.TCP("a:0:0:0:0:1", "12.0.0.1", 20123) >> ("a:0:0:0:0:2", "12.0.0.2", 888)
    fm = FlowMatcher(engine, flow)
    conn = fm.get_connection()
    ...
    flow = IPFlow.TCP("a:0:0:0:0:1", "12.0.0.1", 20123) >> ("a:0:0:0:0:2", "55.44.33.22", 1234)
    fm = FlowMatcher(engine, flow)
    conn = fm.get_connection()
    ...
    flow = IPFlow.TCP("a:0:0:0:0:1", "12.0.0.1", 20123) >> ("a:0:0:0:0:2", "55.44.33.22", 2010)
    fm = FlowMatcher(engine, flow)
    conn = fm.get_connection()
    ...
    # "reverse" direction
    flow = IPFlow.TCP("a:0:0:0:0:1", "12.0.0.1", 9000) << ("a:0:0:0:0:2", "55.44.33.22", 2010)
    fm = FlowMatcher(engine, flow)
    conn = fm.get_connection()
    ...
    flow = IPFlow.TCP("a:0:0:0:0:1", "99.0.0.1", 9000) >> ("a:0:0:0:0:2", "55.44.33.22", 2010)
    fm = FlowMatcher(engine, flow)
    conn = fm.get_connection()
